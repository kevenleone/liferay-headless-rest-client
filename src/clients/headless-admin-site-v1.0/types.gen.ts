...
export type PageSettings = {
    ...
    /**
     * The priority of the page, determining the order in which the page will be listed, for example within the page administration.
     */
    priority?: number;
...
export type SitePage = {
    ...
    /**
     * A list of keywords describing the site page.
     */
    keywords?: Array<string>;
    /**
