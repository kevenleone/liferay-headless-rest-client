...
export const postFunctionalCookieEntryExpire = <ThrowOnError extends boolean = false>(options: Options<PostFunctionalCookieEntryExpireData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostFunctionalCookieEntryExpireResponses, unknown, ThrowOnError>({
