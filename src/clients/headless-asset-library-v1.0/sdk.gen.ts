...
export const deleteAssetLibraryBatch = <ThrowOnError extends boolean = false>(options?: Options<DeleteAssetLibraryBatchData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteAssetLibraryBatchResponses, unknown, ThrowOnError>({
...
export const postAssetLibraryBatch = <ThrowOnError extends boolean = false>(options?: Options<PostAssetLibraryBatchData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostAssetLibraryBatchResponses, unknown, ThrowOnError>({
        url: '/o/headless-asset-library/v1.0/asset-libraries/batch',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Unpins the asset library.
 */
export const deleteAssetLibraryByExternalReferenceCodePin = <ThrowOnError extends boolean = false>(options: Options<DeleteAssetLibraryByExternalReferenceCodePinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteAssetLibraryByExternalReferenceCodePinResponses, unknown, ThrowOnError>({
...
/**
 * Pins the asset library.
 */
export const putAssetLibraryByExternalReferenceCodePin = <ThrowOnError extends boolean = false>(options: Options<PutAssetLibraryByExternalReferenceCodePinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutAssetLibraryByExternalReferenceCodePinResponses, unknown, ThrowOnError>({
        url: '/o/headless-asset-library/v1.0/asset-libraries/by-external-reference-code/{externalReferenceCode}/pins',
        ...options
    });
};
 ...
 * Unpins the asset library.
 */
export const deleteAssetLibraryPin = <ThrowOnError extends boolean = false>(options: Options<DeleteAssetLibraryPinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteAssetLibraryPinResponses, unknown, ThrowOnError>({
 ...
 * Pins the asset library.
 */
export const putAssetLibraryPin = <ThrowOnError extends boolean = false>(options: Options<PutAssetLibraryPinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutAssetLibraryPinResponses, unknown, ThrowOnError>({
        url: '/o/headless-asset-library/v1.0/asset-libraries/{assetLibraryId}/pins',
        ...options
    });
};
...
/**
 * Retrieves the pinned asset libraries.
 */
export const getAssetLibrariesPinnedByMePage = <ThrowOnError extends boolean = false>(options?: Options<GetAssetLibrariesPinnedByMePageData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAssetLibrariesPinnedByMePageResponses, unknown, ThrowOnError>({
