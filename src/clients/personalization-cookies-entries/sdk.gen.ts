...
export const postPersonalizationCookieEntryExpire = <ThrowOnError extends boolean = false>(options: Options<PostPersonalizationCookieEntryExpireData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostPersonalizationCookieEntryExpireResponses, unknown, ThrowOnError>({
