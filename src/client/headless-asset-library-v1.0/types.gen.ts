...
export type AssetLibraryReadable = {
     ...
     */
    readonly userAccounts?: Array<UserAccountReadable>;
    /**
...
export type MimeTypeLimitReadable = {
    readonly maximumSize?: number;
    mimeType?: string;
    readonly 'x-class-name'?: string;
};

export type MimeTypeLimitWritable = {
    mimeType?: string;
};

export type PageAssetLibraryReadable = {
    lastPage?: number;
    totalCount?: number;
    items?: Array<AssetLibraryReadable>;
    actions?: {
        [key: string]: {
            [key: string]: string;
        };
...
export type PageAssetLibraryWritable = {
    lastPage?: number;
    totalCount?: number;
    items?: Array<AssetLibraryWritable>;
    actions?: {
        [key: string]: {
            [key: string]: string;
        };
...
export type SettingsReadable = {
    ...
    logoColor?: string;
    mimeTypeLimits?: Array<MimeTypeLimitReadable>;
...
export type SettingsWritable = {
    ...
    defaultLanguageId?: string;
    logoColor?: string;
    mimeTypeLimits?: Array<MimeTypeLimitWritable>;
    sharingEnabled?: boolean;
    useCustomLanguages?: boolean;
};
...
export type UserAccountReadable = {
    /**
...
export type UserAccountWritable = {
    newsSubscription?: boolean;
    /**
     * Information about the object relationship userToUserAddInfo can be embedded with "nestedFields".
     */
...
export type PageUserAccountReadable = {
    lastPage?: number;
    totalCount?: number;
    items?: Array<UserAccountReadable>;
    actions?: {
        [key: string]: {
            [key: string]: string;
        };
...
export type PageUserAccountWritable = {
    lastPage?: number;
    totalCount?: number;
    items?: Array<UserAccountWritable>;
    actions?: {
        [key: string]: {
            [key: string]: string;
        };
...
export type PageUserGroupReadable = {
    lastPage?: number;
    totalCount?: number;
...
export type PageUserGroupWritable = {
    lastPage?: number;
    totalCount?: number;
    actions?: {
        [key: string]: {
...
export type GetAssetLibrariesPageResponses = {
     ...
     * default response
     */
    default: PageAssetLibraryReadable;
};
...
export type GetAssetLibraryByExternalReferenceCodeUserAccountsPageResponses = {
     ...
     * default response
     */
    default: PageUserAccountReadable;
};
